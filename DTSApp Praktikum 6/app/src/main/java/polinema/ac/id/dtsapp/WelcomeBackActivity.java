...
public class WelcomeBackActivity extends AppCompatActivity {
    ...
    private static final String DUMMY_USERNAME = "matahariku";
    private static final String DUMMY_PASSWORD = "matahariku";
    ...
    private boolean validateCredential()
    {
        ...
        THIS_USER = daoUser.findByUsernameAndPassword(currentUsername, currentPassword);
        if (THIS_USER != null){
            return (Objects.equals(currentUsername, THIS_USER.username)
                    && Objects.equals(currentPassword, THIS_USER.password));
        }else{
            return false;
        }
